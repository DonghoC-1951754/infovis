...
// Import or create WeightBarChart if needed
...
const PlaneStats = () => {
  ...
  const [chartType, setChartType] = useState(null); // "engine" or "weight"

  useEffect(() => {
    // Fetch engine data once on mount
    ...
    // Fetch weight data once on mount
        ...
        <div className="flex flex-col flex-1 bg-white rounded-lg shadow-md p-6">
          <div className="h-20 flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold text-gray-800">
              Correlation between plane specifications and accidents
            </h2>
          </div>
          ...
          <div className="flex-1 bg-gray-100 rounded-md overflow-auto flex flex-row items-center justify-center gap-6 p-4">
            ...
            {/* Right: Bar chart or instruction */}
